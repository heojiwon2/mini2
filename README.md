...
|:----------:|:----------:|:----------:|:----------:|
| 이준경(팀장) | 방효식 | 허지원 | 장수연 |   
| backend | 데이터분석(EDA)<br>FrontEnd | 데이터분석(EDA)<br>ML Model 구축,FrontEnd | 데이터분석(EDA)<br>FrontEnd| 
...
2. auto ml 상위 모델 confusion matrix , roc curves 확인
...
<div style="display: flex; justify-content: center;">
    ...
    <img src="https://github.com/user-attachments/assets/3d163855-5ab1-4f48-a7f8-4139a545a580" height="100" width="300" />
</div>
